...
if (!empty($_POST)) {
    ...
    if ($validator->isValid()) {
        ...
        \App\Model\Session::getInstance()->setFlash(
            'success',
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="my-5">
                        <form id="register-form" method="POST" class="Form">
                            ...
                            <div class="form-floating">
                                <input class="form-control" id="register-lastname"
                                       name="lastname" type="text" placeholder="Entrez votre prénom..." required/>
                                <label for="lastname">Nom</label>
                            </div>
                            <div class="form-floating">
                                <input class="form-control" id="register-firstname"
                                       name="firstname" type="text" placeholder="Entrez votre nom..." required/>
                                <label for="firstname">Prénom</label>
                            </div>
                            <div class="form-floating">
                                <input class="form-control" id="register-email"
                                       name="email" type="text" placeholder="Entrez votre email..." required/>
                            ...
                            <div class="form-floating">
                                <input class="form-control" id="register-confirm-password"
                                       name="password_confirm" type="password"
                                       placeholder="Entrez votre mot de passe..." required/>
                                <label for="password_confirm">Confirmez votre mot de passe</label>
                            </div>
                            <div class="form-floating Form-checkbox">
                                <input class="form-check" id="register-terms"
                                       type="checkbox" name="terms" required/>
                                <label for="terms">
                                    En cochant cette case,
                                    je reconnais avoir pris connaissance de la charte RGPD et en accepte les termes
                                </label>
                            </div>
                            <br/>
                            <!-- Submit Button-->
